...
**Streamlit application**: An interactive application has been developed using Streamlit, which allows exploration and visualisation of the analysed data. It is deployed at (https://agrotechproject00.streamlit.app/). **Note: make sure the app has finished running before exploring it!!**
